# ВНИМАНИЕ! ПРОЕКТ ПЕРЕЕХАЛ НА GITFLIC git@gitflic.ru:solo-it/whatsapp-web.js.git
Ссылка на новый репозиторий <https://gitflic.ru/project/solo-it/whatsapp-web.js>
